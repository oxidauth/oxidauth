...
#[async_trait]
pub trait QueryUserAuthoritiesByAuthorityIdAndUserIdentifier: Send + Sync + 'static {
    ...
    ) -> Result<UserAuthorityRow, QueryUserAuthoritiesByAuthorityIdAndUserIdentifierError>;
}
